...
void setup() {
  ...
  while(!psClient.connected()){
    ...
    if(psClient.connect("H001", mqttUser, mqttPassword)){
      Serial.println("Connected.");
      psClient.publish("esp/test", "Hello World!");
    } else {
  ...
  doCommand(4); //Print array contents
  Serial.println("\n\nSwipe card...\n");
}
